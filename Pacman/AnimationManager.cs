...
namespace Pacman
{
    class AnimationManager
    {
        ...
        public static Rectangle UpWallRec = new Rectangle(1 * Game1.tileSize, 1 * Game1.tileSize, Game1.tileSize, Game1.tileSize);
        ...
        public static Rectangle EastWallTex = new Rectangle(2 * Game1.tileSize, 2 * Game1.tileSize, Game1.tileSize, Game1.tileSize);
